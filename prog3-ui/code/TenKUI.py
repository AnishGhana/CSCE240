...
def print_to_file(start, end):
    ...
    isWithin = False
    f = open(fileName, "r", encoding='utf-8')  # opens the file reader
    g = open("../data/output.txt", "w", encoding='utf-8')  # opens the file writer
    for line in f:
...
def parse_user_input(user_input):
    ...
    if berkshire_pattern.search(user_input):
        ...
        print(user_input + "– I do not know this information")
...
while (not exit):
    ...
    user_input = input(
        "Please enter a question that you have about Berkshire Hathaway or Exxon Mobil, or enter Quit, quit, or q to exit the program.")
